...
Vue.component('phd-item',{
    ...
    template:  
            ...
            '<div class="cardnew" style="height: 330px;">'+
                '<img class="student_image" v-bind:src="phd.img" style="margin-left: 15%; margin-top: 10px;">'+
                ...
                '</div>'+  
                '<div class="cardnew-content" style="height: 85px; top: 240px; overflow-y: scroll; text-align: left; padding-left: 10%;"><b>User-ID :</b> {{phd.userId}}<br><b>Research Area :</b> {{phd.research}}<br><b>e-mail :</b> {{phd.userId}}@iiti.ac.in</div>'+
            '</div>'+
  '</div>' 
})
...
var PhdStudents = new Vue({
    ...
    data: {
      ...
      [    { 
            ...
            profileLink: 'http://people.iiti.ac.in/~phd12120101/'
            },
