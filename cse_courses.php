...
<body>
    ...
    <div class="container" style="background-color:white;s">
...
<h2 class="contenthead">Courses offered by CSE Department, IIT Indore</h2>
<table id="courselist">
...
<!------------------------------ Elective Courses ------------------------------------------------->
<div id="content"><!-- Size could be varied as here height is specified only for viewing purposes-->
<h2 class="contenthead">Elective Courses</h2>
<table id="courselist">
